// app/annuaire-china.tsx — China Directory Screen (Simplified)
...
registerTranslations({
  'Annuaire China': 'China Directory',
});

const CHINA_CATEGORIES = CITY_CATEGORIES['China'] || ['Automobile', 'Diverse', 'Other', 'Services'];

export default function AnnuaireChinaScreen() {
        ...
        <>
          ...
          <View style={{ width: '100%', alignItems: 'center' }}>
            <View style={{ width: '100%', maxWidth: 900, paddingHorizontal: 16 }}>
              ...
              >
                <View style={{ flex: 1 }}>
                  <Text style={[styles.regionToggleTitle, { color: theme.text }]}>🇨🇳 China Directory</Text>
              ...
              {/* CATEGORY FILTER - Only China categories */}
              <FlatList
                horizontal
                data={['Tous', ...CHINA_CATEGORIES] as (Category | 'Tous')[]}

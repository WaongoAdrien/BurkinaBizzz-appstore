// app/annuaire-southkorea.tsx — South Korea Directory Screen
...
registerTranslations({
  'Annuaire South Korea': 'South Korea Directory',
});

const SOUTHKOREA_CATEGORIES = CITY_CATEGORIES['South Korea'] || ['Automobile', 'Diverse', 'Other', 'Services'];

export default function AnnuaireSouthKoreaScreen() {
  ...
  // Fetch ONLY South Korea businesses
  useEffect(() => {
    const q = query(
      collection(db, 'businesses'),
      where('status', '==', 'approved'),
      where('city', '==', 'South Korea'),
        ...
        <>
          ...
          <View style={{ width: '100%', alignItems: 'center' }}>
            <View style={{ width: '100%', maxWidth: 900, paddingHorizontal: 16 }}>
              ...
              >
                <View style={{ flex: 1 }}>
                  <Text style={[styles.regionToggleTitle, { color: theme.text }]}>🇰🇷 South Korea Directory</Text>
              ...
              {/* CATEGORY FILTER - Only South Korea categories */}
              <FlatList
                horizontal
                data={['Tous', ...SOUTHKOREA_CATEGORIES] as (Category | 'Tous')[]}
